...
final int attendee_contractors;
  ...
  factory Table_Attendee.fromJson(Map<String, dynamic> json) {
    ...
    return Table_Attendee(
      ...
      fldAttendance: json['fld_attendance'] != null?json['fld_attendance']is int ?json['fld_attendance']:int.parse(json['fld_attendance'].toString()):0,//safeExtract('fld_attendance', 0) is int ? safeExtract('fld_attendance', 0) : int.tryParse(safeExtract('fld_attendance', '0').toString()) ?? 0,
