...
class PendingView extends GetView<AttendeeController> {
    ...
    return CustomScrollView(
      ...
      slivers: [
        ...
        Obx(() =>   ListView.separated(
                ...
                itemCount:controller.panddingList.length,
                itemBuilder: (context, index) {
                  Table_Attendee order = controller.panddingList[index];
                  print("object${order.fldAttendance}===${order.fldAttendeeName}");
                  return Container(
                   // height: 108,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            if (order.fldAttendance == 1 || order.fldInvites == 1)
                              InkWell(child: Row(children: [ const Icon(Icons.edit_note_outlined, size: 30,color:  Colors.red,),
                                Text(
                                "Fill Data",
                                style: TextStyle(
                                  fontSize: 13,
