...
import '../view/PermissionDeniedPage.dart';
...
class PermissionController extends GetxController with WidgetsBindingObserver{
  ...
  Future<void> requestPermission(Permission permission) async {
    ...
    if (status.isPermanentlyDenied) {
      Get.snackbar(backgroundColor: AppColors.primaryColor.withOpacity(0.2),
        'Permission Denied',
  ...
  String getButtonText(Permission permission) {
    return permissionsStatus[permission]?.isGranted == true ? 'Allowed' : 'Allow';
  }
