...
print(bottomInsets);
    return Scaffold(
      ...
      resizeToAvoidBottomInset: true, // Adjusts when the keyboard is opened
      // body: Stack(
      //   children: [
      ...
      body:   Center(child:     Container(
              ...
              child: SingleChildScrollView(
                child: Form(
                  key: _formKey,
                  child:Obx(() =>controller.isLoading.value ? const Center(child: CircularProgressIndicator()) : Column(
                    children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintStyle: Styles.inriaSansBold.copyWith(
                                              fontSize: Dimensions.fontSizeExtraLarge,
                                              color: AppColors.black,
                                              fontWeight: FontWeight.w400),
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            controller.validateAndProcess(phoneController.text.toString(),passwordController.text.toString());
                          },
                          child: Text(
                            'Login',
                            style: Styles.inriaSansBold.copyWith(
