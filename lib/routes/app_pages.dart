...
import 'package:jsw/features/attendee/binding/AttendeeBinding.dart';
import 'package:jsw/features/attendee/view/AddAttendee2View.dart';
import 'package:jsw/features/attendee/view/AddAttendeeView.dart';
import 'package:jsw/features/attendee/view/AttendeeView.dart';
import 'package:jsw/features/contactor/binding/contactorBinding.dart';
import 'package:jsw/features/contactor/view/contactorview.dart';
import 'package:jsw/features/history/bindings/MeetingHistoryBindings.dart';
import 'package:jsw/features/history/view/Meeting_HistoryView.dart';
...
part 'package:jsw/routes/app_routes.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.Contactor,
      page: () => ContactorView(),
      binding: ContactorBinding(),
    ),
    // GetPage(
    //   name: _Paths.Address,
    //   page: () => AddressView(),
