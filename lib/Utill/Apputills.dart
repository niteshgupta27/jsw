...
class AppUtils {
  ...
  static Future<bool> checkInternetConnectivity() async {
    final jswivityResult = await (Connectivity().checkConnectivity());
    if (jswivityResult == ConnectivityResult.mobile) {
      debugPrint("User is connectivity to mobile network");
      return true;
    } else if (jswivityResult == ConnectivityResult.wifi) {
      debugPrint("User is connectivity to wifi network");
      return true;
    } else {
//showToast("Check Internet jswivity");
      return false;
    }
  }
